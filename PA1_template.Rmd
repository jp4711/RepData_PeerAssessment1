...
avgStepsPerIntervalD4 <- aggregate(steps ~ interval, D3, mean)  
```
...
plot(avgStepsPerIntervalD3$interval, avgStepsPerIntervalD3$steps, type = "l", main="Avg # of Steps per Interval on weekdays", xlab="Interval", ylab="Number of Steps")
```

```{r}
plot(avgStepsPerIntervalD3$interval, avgStepsPerIntervalD3$steps, type = "l", main="Avg # of Steps per Interval on weekend", xlab="Interval", ylab="Number of Steps")
